...
int main(int argc, const char * argv[]) {
    ...
    while(!glfwWindowShouldClose(window.GetWindow())) {
        ...
        //mesh.SetVBOData(&m->vertices[0], GL_DYNAMIC_DRAW, m->vertices.size() * sizeof(glm::vec3)); //set the vertices data
        //mesh.SetNormalVBOData(&m->normals[0], GL_DYNAMIC_DRAW, m->normals.size() * sizeof(glm::vec3)); //set the normals data
